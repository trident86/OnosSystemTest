...
class MyTopo( Topo ):
    ...
    def __init__( self ):
        ...
        host2 = self.addHost( 'h2', ip='10.1.0.3/24' )

        # Switch S2 Hosts
        # IPv4 only Host
        host3 = self.addHost( 'h3', ip='10.1.0.4/24' )
        host4 = self.addHost( 'h4', ip='10.1.0.5/24' )

        # Switch S3 Hosts
        # IPv4 only Host
        host5 = self.addHost( 'h5', ip='10.1.0.6/24' )
        host6 = self.addHost( 'h6', ip='10.1.0.7/24' )
